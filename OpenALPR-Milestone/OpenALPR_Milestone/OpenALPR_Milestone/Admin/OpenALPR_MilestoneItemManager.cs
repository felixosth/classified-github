...
namespace OpenALPR_Milestone.Admin
{
    ...
    /// </summary>
    public class OpenALPR_MilestoneItemManager : ItemManager
    {
        private OpenALPR_MilestoneUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public OpenALPR_MilestoneItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        public override void Init()
        {
            ...
            {
                var item = Configuration.Instance.GetItem(OpenALPR_MilestoneDefinition.OpenALPR_MilestoneConfigItemId, _kind);

                if (item == null)
                {
                    item = new Item(GenerateFQID(OpenALPR_MilestoneDefinition.OpenALPR_MilestoneConfigItemId), "Configuration");
                    Configuration.Instance.SaveItemConfiguration(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, item);
                }
        ...
        internal static FQID GenerateFQID(Guid id) => new FQID(EnvironmentManager.Instance.MasterSite.ServerId, Guid.Empty, id, FolderType.UserDefined, OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId);
        ...
        {
            _userControl = new OpenALPR_MilestoneUserControl();
        ...
        {
            return new OpenALPR_MilestoneAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((OpenALPR_MilestoneAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(OpenALPR_MilestoneDefinition.OpenALPR_MilestonePluginId, _kind, fqid.ObjectId);
            return item;
        }
