...
namespace EyeTrackerTest.Client
{
    ...
    /// </summary>
    public class EyeTrackerTestViewItemPlugin : ViewItemPlugin
    {

        public EyeTrackerTestViewItemPlugin()
        {
        }
        ...
        {
            get { return EyeTrackerTestDefinition.EyeTrackerTestViewItemPlugin; }
        }


        public override System.Drawing.Image Icon
        {
            get { return EyeTrackerTestDefinition.TreeNodeImage; }
        }
        ...
        {
            return new EyeTrackerTestViewItemManager();
        }
