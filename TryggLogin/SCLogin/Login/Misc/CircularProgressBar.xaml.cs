...
namespace LoadingPanelSample.Controls
{
    ...
    public partial class CircularProgressBar
    {
        ...
        public static readonly DependencyProperty SpinIntervalProperty =
            DependencyProperty.Register("SpinInterval", typeof(TimeSpan), typeof(CircularProgressBar), 
                new FrameworkPropertyMetadata(new TimeSpan(0, 0, 0, 0, 75), FrameworkPropertyMetadataOptions.AffectsRender, OnSpinIntervalChanged));

        private static void OnSpinIntervalChanged(DependencyObject defectImageControl, DependencyPropertyChangedEventArgs eventArgs)
        {
            var control = (CircularProgressBar)defectImageControl;
            control.SpinInterval = (TimeSpan)eventArgs.NewValue;
        }
        ...
        public TimeSpan SpinInterval
        {
            get { return (TimeSpan)GetValue(SpinIntervalProperty); }
            set 
            {
                _animationTimer.Interval = value;
                SetValue(SpinIntervalProperty, value);
            }
        }
