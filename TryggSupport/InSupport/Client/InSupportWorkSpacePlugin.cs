...
{
    public class InSupportWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return InSupportDefinition.InSupportWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            //rectangles.Add(new Rectangle(000, 500, 500, 500));      // Index 0 = Used by a camera below
            //rectangles.Add(new Rectangle(000, 500, 500, 500));      // Index 1 = the sample ViewItem
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(0, new InSupportWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
            //ViewAndLayoutItem.InsertViewItemPlugin(1, new InSupportWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
            ...
            //properties2.Add("HideNavigationBar", "true");
