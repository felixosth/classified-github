...
namespace InSupport.Client
{
    ...
    /// </summary>
    public class InSupportSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        {
            return new InSupportSidePanelUserControl();
        }
        ...
        {
            get { return InSupportDefinition.InSupportSidePanel; }
        }
        ...
        {
            get { return "InSupport Side panel"; }
        }
