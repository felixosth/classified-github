...
namespace InSupport.Client
{
    ...
    /// </summary>
    public partial class InSupportPropertiesUserControl : PropertiesUserControl
    {
        ...
        public InSupportPropertiesUserControl(InSupportViewItemManager viewItemManager)
        {
