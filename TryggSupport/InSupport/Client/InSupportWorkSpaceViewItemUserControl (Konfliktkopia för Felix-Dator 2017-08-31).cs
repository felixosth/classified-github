...
namespace InSupport.Client
{
    public partial class InSupportWorkSpaceViewItemUserControl : ViewItemUserControl
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            if(Properties.Settings.Default.Debug)
            {
                debugLabel.Text = this.Size.ToString();
            }
        ...
        private void InSupportWorkSpaceViewItemUserControl_Load(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(ClientControl.Instance.Theme.ThemeType.ToString());
            ...
            //MessageBox.Show(NTPTime.GetNetworkTime().ToShortTimeString());
            ...
            using (var webClient = new WebClient())
            {
                webClient.DownloadStringCompleted += GetCriticalInfo_DownloadStringCompleted;
                webClient.DownloadStringAsync(new Uri("http://83.233.164.117/pluginhttp/criticalInfo.txt"));
            }

            //var myControl = label3;
        ...
        private void GetCriticalInfo_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            if (e.Error == null)
        ...
        private void GetExternalIp_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            if (e.Error == null)
        ...
        private void emailSendBtn_Click(object sender, EventArgs e)
        {
            ...
            using (var mailClient = new SmtpClient())
            {
                ...
                var body = new TextPart("plain") { Text = emailName.Text + " (" + emailCompany.Text + ")\n" + emailEmail.Text + "\n" + emailTele.Text + "\n\nMeddelande:\n" + emailBody.Text + "\n\n" + localIpLabel.Text + "\n" + userInfoLabel.Text };
                ...
                //    catch { MessageBox.Show("Kunde inte skicka mail. Kontakta oss direkt."); }
                //}).Start();
        ...
        {
            ProblemBrowser pB = new ProblemBrowser();
            pB.Show();
        }
        ...
        private void attachCamBtn_Click(object sender, EventArgs e)
        {
            ...
            using (ItemPickerForm itemPicker = new ItemPickerForm())
            {
                ...
                if (itemPicker.ShowDialog() == DialogResult.OK)
                {
                    ...
                    camName = camera.Name;
                    var camSnap = new GetCameraSnapshotForm(camera);
