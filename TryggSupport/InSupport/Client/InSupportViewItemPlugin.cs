...
namespace InSupport.Client
{
    ...
    /// </summary>
    public class InSupportViewItemPlugin : ViewItemPlugin
    {

        public InSupportViewItemPlugin()
        {
        ...
        {
            get { return InSupportDefinition.InSupportViewItemPlugin; }
        }


        public override System.Drawing.Image Icon
        {
            get { return InSupportDefinition.TreeNodeImage; }
        }
        ...
        {
            return new InSupportViewItemManager();
        }
