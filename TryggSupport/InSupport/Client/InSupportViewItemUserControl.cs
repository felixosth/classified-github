...
namespace InSupport.Client
{
    ...
    /// </summary>
    public partial class InSupportViewItemUserControl : ViewItemUserControl
    {
        #region Component private class variables

        private InSupportViewItemManager _viewItemManager;
        ...
        /// <summary>
        /// Constructs a InSupportViewItemUserControl instance
        /// </summary>
        public InSupportViewItemUserControl(InSupportViewItemManager viewItemManager)
        {
