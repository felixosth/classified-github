...
namespace InSupport.Client
{
    ...
    /// </summary>
    public class InSupportOptionsDialogPlugin : OptionsDialogPlugin
    {
        ...
        {
            LoadProperties(true);
            return new InSupportOptionsDialogUserControl();
        }
        ...
        {
            get { return InSupportDefinition.InSupportOptionsDialog; }
        }
        ...
        {
            get { return "InSupport Alternativ"; }
        }
