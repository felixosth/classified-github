...
namespace InSupport.Admin
{
    ...
    /// </summary>
    public class InSupportItemManager : ItemManager
    {
        private InSupportUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public InSupportItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new InSupportUserControl();
        ...
        {
            return new InSupportAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(InSupportDefinition.InSupportPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((InSupportAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(InSupportDefinition.InSupportPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(InSupportDefinition.InSupportPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(InSupportDefinition.InSupportPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(InSupportDefinition.InSupportPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(InSupportDefinition.InSupportPluginId, _kind, fqid.ObjectId);
            return item;
        }
