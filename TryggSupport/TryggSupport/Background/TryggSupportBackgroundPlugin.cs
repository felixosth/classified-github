...
namespace TryggSupport.Background
{
    /// <summary>
    ...
    /// </summary>
    public class TryggSupportBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return TryggSupportDefinition.TryggSupportBackgroundPlugin; }
        }
        ...
        {
            get { return "TryggSupport BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "TryggSupport Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "TryggSupport background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "TryggSupport background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
