...
namespace TryggSupport.Client
{
    ...
    /// </summary>
    public class TryggSupportViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public TryggSupportViewItemManager() : base("TryggSupportViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(TryggSupportDefinition.TryggSupportPluginId, null, TryggSupportDefinition.TryggSupportKind);
        ...
        //{
        //	return new TryggSupportPropertiesUserControl(this);
        //}
        ...
        {
            return new TryggSupportPropertiesWpfUserControl(this);
        }
