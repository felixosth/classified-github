...
{
    public class TryggSupportSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return TryggSupportDefinition.TryggSupportSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "TryggSupport"; } }
        ...
        {
            _userControl = new TryggSupportSettingsPanelControl(this);
            return _userControl;
        }
