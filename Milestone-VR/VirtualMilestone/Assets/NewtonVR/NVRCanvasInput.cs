    ...
    public class NVRCanvasInput : BaseInputModule
    {
        ...
        protected override void Start()
        {
            ...
            if (Initialized == false)
            {
                ...
                //var cam = GameObject.Find("Controller UI Camera");
                //if (cam != null)
                //    ControllerCamera = cam.GetComponent<Camera>();

                //if(ControllerCamera == null)
                ControllerCamera = new GameObject("Controller UI Camera").AddComponent<Camera>();

                GameObjectsToDestroy.Add(ControllerCamera.gameObject);
                ...
                {
                    //GameObject cursor = GameObject.Find("Cursor for " + Player.Hands[index].gameObject.name);
                    //if(cursor == null)
                    GameObject cursor = new GameObject("Cursor for " + Player.Hands[index].gameObject.name);
                    GameObjectsToDestroy.Add(cursor);
