...
public class MediaPlayerCtrl : MonoBehaviour
{
	...
	void Awake()
	{
		...
		if (UnityEngine.SystemInfo.deviceModel.Contains("rockchip"))
		{
	...
	#if UNITY_5
	if( UnityEngine.SystemInfo.graphicsMultiThreaded == true)
	InitNDK();
	#endif
	...
	#if UNITY_5
		if( UnityEngine.SystemInfo.graphicsDeviceType == UnityEngine.Rendering.GraphicsDeviceType.Direct3D9)
		{
