...
namespace TryggRetail.Client
{
    ...
    /// </summary>
    public class TryggRetailViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public TryggRetailViewItemManager() : base("TryggRetailViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(TryggRetailDefinition.TryggRetailPluginId, null, TryggRetailDefinition.TryggRetailKind);
        ...
        //{
        //	return new TryggRetailViewItemUserControl(this);
        //}
        ...
        {
            return new TryggRetailViewItemWpfUserControl(this);
        }

        public override ViewItemUserControl GenerateViewItemUserControl()
        {
            //return base.GenerateViewItemUserControl();
            return new ViewItemUserControl();
        }
        ...
        //{
        //	return new TryggRetailPropertiesUserControl(this);
        //}
        ...
        //{
        //    return new TryggRetailPropertiesWpfUserControl(this);
        //}
