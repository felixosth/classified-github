...
namespace TryggRetail.Client
{
    ...
    /// </summary>
    public class TryggRetailViewItemPlugin : ViewItemPlugin
    {

        public TryggRetailViewItemPlugin()
        {
        }
        ...
        {
            get { return TryggRetailDefinition.TryggRetailViewItemPlugin; }
        }


        public override System.Drawing.Image Icon
        {
            get { return TryggRetailDefinition.TreeNodeImage; }
        }
        ...
        {
            return new TryggRetailViewItemManager();
        }
