...
{
    public class TryggRetailSettingsPanelPlugin : SettingsPanelPlugin
    {
        private UserControl _userControl;
        TryggRetailBackgroundPlugin back;

        public TryggRetailSettingsPanelPlugin(TryggRetailBackgroundPlugin back)
        {
            this.back = back;
        }
        ...
        {
            get { return TryggRetailDefinition.TryggRetailSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "TryggRetail"; } }
        ...
        {
            _userControl = new TryggRetailSettingsPanelControl(back);
            return _userControl;
        }
