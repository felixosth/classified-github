...
namespace REIDMipDriver
{
    ...
    /// </summary>
    internal abstract class BaseREIDMipDriverStreamSession : BaseStreamSession
    {
        public Guid Id { get; }
        ...
        protected readonly REIDMipDriverConnectionManager _connectionManager;
        ...
        public BaseREIDMipDriverStreamSession(ISettingsManager settingsManager, REIDMipDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId)
        {
            Id = sessionId;
