...
{
    public class ReidAddToolbarPlugin : SearchToolbarPlugin
    {
        public override Guid Id { get; protected set; } = new Guid("{56D3F9BE-B634-480A-B96B-823D28D5E2EF}");
        public override string Name { get; protected set; } = "ReidAddToDb";

        public ReidAddToolbarPlugin()
        {
        ...
        {
            return new ReidAddToolbarInstance();
        }
    }
}
