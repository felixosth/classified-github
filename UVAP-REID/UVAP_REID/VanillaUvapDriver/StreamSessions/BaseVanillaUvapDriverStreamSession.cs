...
namespace VanillaUvapDriver
{
    ...
    /// </summary>
    internal abstract class BaseVanillaUvapDriverStreamSession : BaseStreamSession
    {
        public Guid Id { get; }
        ...
        protected readonly VanillaUvapDriverConnectionManager _connectionManager;
        ...
        public BaseVanillaUvapDriverStreamSession(ISettingsManager settingsManager, VanillaUvapDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId)
        {
            Id = sessionId;
        ...
        private void SettingsManager_OnSettingsChanged(object sender, VideoOS.Platform.DriverFramework.Data.Settings.SettingsChangedEventArgs e)
        {
