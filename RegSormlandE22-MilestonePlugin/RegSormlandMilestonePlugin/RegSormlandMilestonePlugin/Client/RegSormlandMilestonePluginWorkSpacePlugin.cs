...
{
    public class RegSormlandMilestonePluginWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(0, new RegSormlandMilestonePluginWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
        }
