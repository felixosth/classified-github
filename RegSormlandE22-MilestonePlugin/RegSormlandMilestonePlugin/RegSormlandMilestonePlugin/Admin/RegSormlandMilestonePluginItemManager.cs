...
namespace RegSormlandMilestonePlugin.Admin
{
    ...
    /// </summary>
    public class RegSormlandMilestonePluginItemManager : ItemManager
    {
        private RegSormlandMilestonePluginUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public RegSormlandMilestonePluginItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        public override void Init()
        {
            ...
            {
                CurrentItem = Configuration.Instance.GetItem(RegSormlandMilestonePluginDefinition.ConfigItemGuid, RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginKind);

                if (CurrentItem == null)
                {
                    var cfgItem = new Item(GenerateFQID(RegSormlandMilestonePluginDefinition.ConfigItemGuid), "Configuration");
                    Configuration.Instance.SaveItemConfiguration(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, cfgItem);
                }
            }
        }
        ...
        {
            _userControl = new RegSormlandMilestonePluginUserControl();
        ...
        {
            return new RegSormlandMilestonePluginAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((RegSormlandMilestonePluginAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginPluginId, _kind, fqid.ObjectId);
            return item;
        }
        ...
        static FQID GenerateFQID(Guid id) => new FQID(EnvironmentManager.Instance.MasterSite.ServerId, Guid.Empty, id, FolderType.UserDefined, RegSormlandMilestonePluginDefinition.RegSormlandMilestonePluginKind);
    }
}
