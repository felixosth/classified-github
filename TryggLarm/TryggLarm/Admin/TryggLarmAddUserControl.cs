...
namespace TryggLarm.Admin
{
    ...
    /// </summary>
    public partial class TryggLarmAddUserControl : UserControl
    {
        public TryggLarmAddUserControl()
        {
            InitializeComponent();
        }
        ...
        private void TryggLarmAddUserControl_Load(object sender, EventArgs e)
        {
