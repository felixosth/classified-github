...
namespace MilestoneToDrive.Convert
{
    public class FFMPEG
    {
        string ffmpegPath;
        ...
        public string ConvertVideo(string file)
        {
            ...
            switch (ConvertMethod.ToLower())
            {
                ...
                default:
                    ...
                    defaultLine = $"-y -i \"{file}\" -codec copy -f mp4 \"{tmpFile}\"";

                    break;
                case "transcode":
                case "convert":
                    defaultLine = $"-y -i \"{file}\" -vcodec libx264 -crf 26 -preset fast -tune fastdecode -f mp4 \"{tmpFile}\"";
                    break;
