...
{
    public class BergendahlsPOSSettingsPanelPlugin : SettingsPanelPlugin
    {
        private UserControl _userControl;

        internal const string CamerasSettingsKey = "Cameras";
        internal const string StoreIDSettingsKey = "StoreID";
        ...
        {
            get { return BergendahlsPOSDefinition.BergendahlsPOSSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "POS data"; } }
        ...
        {
            _userControl = new BergendahlsPOSSettingsPanelControl(this);
            return _userControl;
        }
