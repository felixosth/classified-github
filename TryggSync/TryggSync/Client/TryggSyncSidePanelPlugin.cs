...
namespace TryggSync.Client
{
    ...
    /// </summary>
    public class TryggSyncSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new TryggSyncSidePanelUserControl();
        //}
        ...
        {
            return new TryggSyncSidePanelWpfUserControl();
        }
        ...
        {
            get { return TryggSyncDefinition.TryggSyncSidePanel; }
        }
        ...
        {
            get { return "TryggSync Side panel"; }
        }
