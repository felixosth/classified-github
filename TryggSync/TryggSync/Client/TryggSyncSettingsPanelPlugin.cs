...
{
    public class TryggSyncSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return TryggSyncDefinition.TryggSyncSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "TryggSync"; } }
        ...
        {
            _userControl = new TryggSyncSettingsPanelControl(this);
            return _userControl;
        }
