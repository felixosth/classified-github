...
namespace TryggSync.Client
{
    ...
    /// </summary>
    public class TryggSyncViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public TryggSyncViewItemManager() : base("TryggSyncViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(TryggSyncDefinition.TryggSyncPluginId, null, TryggSyncDefinition.TryggSyncKind);
        ...
        //{
        //	return new TryggSyncViewItemUserControl(this);
        //}
        ...
        {
            return new TryggSyncViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new TryggSyncPropertiesUserControl(this);
        //}
        ...
        {
            return new TryggSyncPropertiesWpfUserControl(this);
        }
